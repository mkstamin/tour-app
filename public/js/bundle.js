        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully! Wait for a while.....');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Loging Out.....! 😊');
              location.assign('/');
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2F2YW5uYWg3ODUiLCJhIjoiY2tud3NzbnVnMGpwMTJ3dGc2Zzc0cjNmZyJ9.mSqPE7jbR6l17mDDAtKrrw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signup is successfully! Wait for a while.....'); // location.replace('/me');
...
var stripe = Stripe('pk_test_51ImDNKFOvHk9kxQndyyL7TQNSOcQulN3yiqqtG8txJUzPnm37ssbssdzIiQyvrnhH2jNRLnJn5sV1KkFWvJUuEgD00HyHjeNax');
...
var singupForm = document.getElementById('signup-form');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var louOutBtn = document.querySelector('.nav__el--logout');
var btnSavePassword = document.querySelector('.btn-save-password');
var bookBtn = document.getElementById('book-btn'); //Delegation'
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('passwordConfirm').value; // const data = {
...
if (louOutBtn) louOutBtn.addEventListener('click', _login.logout);
